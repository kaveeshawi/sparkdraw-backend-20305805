...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'agency.scope'])->group(function () {
        ...
        Route::middleware('role:admin,pm,client')->group(function () {
        ...
        Route::middleware('role:admin,pm,member')->group(function () {
            ...
            // Tasks — agency-wide, across all projects (My Tasks nav page)
            ...
            Route::middleware('role:admin,pm')->group(function () {
                ...
                // Team management (GET available to admin+pm; mutations admin only below)
